<!-- Admin/Manage_Account/index.php -->
<?php
require 'db_conn.php'; 
include '../auth.php'; 
...
try {
    $query = "SELECT * FROM admin WHERE name LIKE ?";
    ...
    <th style="width: 120px;">Actions</th>
      ...
      <tbody>
        <?php while ($row = $result->fetch_assoc()): ?>
          <tr>
          <td class="user-photo">
                    <img src="../Admin_Account/upload/<?= $row['photo'] ?>" 
                         alt="User Photo" 
            ...
            <td class="actions" data-label="Actions">
              <a href="view.php?id=<?= $row['id'] ?>" class="btn view">
